  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:text-primary data-[state=active]:border-b-primary data-[state=active]:shadow-[0_2px_1px_0px_rgba(180,150,255,0.6),0_1px_2px_0px_rgba(255,255,255,0.5)] data-[state=active]:bg-primary/5",
